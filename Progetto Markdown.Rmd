  ...
  sidebarLayout(
    ...
    mainPanel(
      tabsetPanel(type="tabs",
          ...
          tabPanel("Classic",plotlyOutput("bootstr", width = "100%", height = 600),
                    verbatimTextOutput("bootstr.text")),
          tabPanel("Block",plotlyOutput("blockboot", width = "100%", height = 600),
...
knitr::kable(all.interval,caption = "Conf. Interval (block bootstrap)",digits = 4, "pipe")
```
